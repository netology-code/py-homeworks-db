...
<details>
    <summary>
      <b>
        Установочные файлы PostgreSQL и DBeaver Community (нажмите, чтобы раскрыть)
      </b>
    </summary>
Если не открываются страницы на скачивание ПО, скачайте файлы по ссылке: https://disk.360.yandex.ru/d/j2jbm18GqnrbPg. Выберите подходящие под вашу операционную систему и процессор.
</details>
